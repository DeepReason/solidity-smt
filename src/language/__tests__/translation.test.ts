...
import { getSolidityData } from '../../sol_parsing/analyze_solidity';
...
} from '../../sol_parsing/solidityZ3Generator';
...
const solidityData = getSolidityData(SOLIDITY_INPUT);
...
describe('Test add func valid', () => {
  ...
  beforeAll(async () => {
    z3 = await makeZ3();
    z3SolidityGenerators = solidityDataToZ3Generators(solidityData);
