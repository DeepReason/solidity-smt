...
import { getSolidityData } from './src/sol_parsing/parse_solidity.js';
import { solidityDataToZ3Generators } from './src/translate/solidityZ3Generator.js';
import { textToZ3 } from './src/translate/toZ3.js';
import makeZ3 from './src/z3/z3.js';
import { repr_of_expr } from './src/z3/repr.js';
const program = new Command();
function create_generators(options) {
...
program
    ...
    .option('-s, --parsed-solidity <parsed_solidity>', 'Parsed SOLC Output (Generate using the `solidity-smt parse` command)')
